...
import com.restapi.service.EmployeeServiceImpl;
...
public class EmployeeController {
	...
	public ResponseEntity<List<Employee>> employeeList(@PathVariable("managerId") Integer managerId) {
	...
	public ResponseEntity<Employee> getEmployeeById(@PathVariable(value="managerId") Integer managerId, @PathVariable(value = "id") Integer employeeId) {
	...
	public ResponseEntity<Employee> createEmployee(@PathVariable("managerId") Integer managerId, @Valid @RequestBody Employee employee) {
	...
	public ResponseEntity<Employee> updateEmployee(@PathVariable("managerId") Integer managerId, @PathVariable(value = "id") Integer employeeId,
	...
	public ResponseEntity<Employee> deleteEmployee(@PathVariable("managerId") Integer managerId, @PathVariable(value = "id") Integer employeeId) {
